...
/**
 * Panel que muestra el catálogo de zapatillas y permite la interacción con el patrón Decorator.
 * También actúa como un Observador para actualizar el stock en tiempo real.
 */
